...
Do not show this entire list to the participant.

- Duration: about 3 weeks.
- Location: mainly wrist and base of thumb.
- Feeling: aching/sore.
- Aggravated by: gripping and twisting.
- Activity: pickleball.
- Goal: wants to keep playing.
- Support priority: preserve as much useful movement as practical.
...
> “This is a prototype, and this is not a test of you or your medical knowledge. Use it naturally and tell me what you are thinking. Start by telling Keneflex only: ‘My hand has been bothering me.’ If Keneflex asks for information about the scenario, I’ll give you that fact. There are no right reactions to the site. Criticism is useful.”
...
1. Open the participant start page.
2. Participant begins with only “My hand has been bothering me.”
3. Let Keneflex ask its questions. Supply standardized facts only when needed.
4. Encourage think-aloud behavior without coaching.
5. Observe whether Keneflex narrows vague hand language, asks rather than assumes, remembers prior facts, handles safety/provider constraints, understands activity/goals, makes the recommendation feel earned, and presents a coherent solution rather than a product list.
6. Stop when the **initial full solution** is presented. Do not use **Adjust My Solution** yet.

## Phase A debrief — lock before tuning
...
- What information you gave seemed to affect the answer?
- What still feels unanswered, missing, or unproven?
...
- **CLOSED:** participant would act without meaningful additional product-selection research.
- **CONFIRMATION:** product choice is essentially made; participant wants a quick credibility, price, delivery, seller, or review check that does not reopen product selection.
- **REOPENED:** participant intends to compare alternatives, search Google/Amazon/Reddit, ask ChatGPT for competing products, or otherwise redo product selection. This is the thesis-level failure state.

## Phase B — Solution tuning
...
## Phase C — Live ChatGPT comparison

Do not show a prewritten ChatGPT answer. Start a fresh ChatGPT conversation with no Keneflex context. The participant begins with exactly:

> **“My hand has been bothering me.”**

Say:

> “Use ChatGPT the way you normally would if this were your problem. Answer its questions using the scenario facts I give you. Ask follow-up questions if you normally would. Tell me when you feel you have enough to decide what to do, or when you would go somewhere else.”

Supply the same private scenario facts only as needed. Do not improve the participant’s prompts.
...
## Phase E — Founder-intent reveal

Only at the end, read neutrally:
...
Also observe the affiliate disclosure. Ask whether learning that Keneflex may make money from some purchases affected trust and why. We want commercial trust to survive disclosure, not depend on hiding the business model.
