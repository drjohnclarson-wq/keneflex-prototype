...
check(route.includes("searchParams.set('participant','061')"), 'participant route requests consolidated release 0.6.1');
...
check(html.includes('participant-consolidated.css?v=061'), 'participant route loads consolidated styles');
...
check(participant.includes("release: '0.6.1'"), 'participant model identifies consolidated release');
